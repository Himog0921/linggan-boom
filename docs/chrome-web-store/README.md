...
- Extension: 灵感爆爆爆
- Version: 2.0.90
- Upload ZIP: `releases/linggan-boom-v2.0.90.zip`
...
```bash
npm run build
npm run release:verify -- --version 2.0.90 --zip releases/linggan-boom-v2.0.90.zip
node --test
```
...
3. Upload `releases/linggan-boom-v2.0.90.zip`.
