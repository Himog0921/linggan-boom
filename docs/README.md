...
Chrome 商店上架相关(store-listing / privacy-policy / reviewer-notes / dashboard 填表速查)。当前候选代码对齐版本 **v2.0.93**；实际商店上传状态以 `chrome-web-store/README.md` 的分项说明为准。
